...
# fig.add_trace(go.Choropleth(
#     locations=df['Country/Region'], #Set location country/region name in csv file
#     z = df['3/1/20'].astype(int), # Data to be color-coded
#     locationmode = 'country names', #set of locations match entries in `locations`
#     colorscale = 'Greens',
#     colorbar_title = "Recovered Cases",
#     name='3/1/20'
...
# fig.add_trace(go.Choropleth(
#     locations=df['Country/Region'], #Set location country/region name in csv file
#     z = df['4/1/20'].astype(int), # Data to be color-coded
#     locationmode = 'country names', #set of locations match entries in `locations`
#     colorscale = 'Greens',
#     colorbar_title = "Recovered Cases",
#     name='4/1/20'
...
# fig.add_trace(go.Choropleth(
#     locations=df['Country/Region'], #Set location country/region name in csv file
#     z = df['4/17/20'].astype(int), # Data to be color-coded
#     locationmode = 'country names', #set of locations match entries in `locations`
#     colorscale = 'Greens',
#     colorbar_title = "Recovered Cases",
#     name='4/17/20'
...
# fig.add_trace(go.Choropleth(
#     locations=df['Country/Region'], #Set location country/region name in csv file
#     z = df['5/5/20'].astype(int), # Data to be color-coded
#     locationmode = 'country names', #set of locations match entries in `locations`
#     colorscale = 'Greens',
#     colorbar_title = "Recovered Cases",
#     name='5/5/20'
...
#len(fig.data[0]
steps = []
#for i in range(0,(len(df.iloc[0]))-4):
